...
with open(filepath, "w") as f:      #vytvori subor vo filepath a napise "w". as sa pouziva na urcenie mena premennej ked sa pouziva with. f.write("xx") napise nieco do toho suboru
    f.write("Hello world!")